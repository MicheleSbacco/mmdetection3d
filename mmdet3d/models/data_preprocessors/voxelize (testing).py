...
class DynamicScatter3D(nn.Module):
    ...
    def forward(self, points: torch.Tensor,
        ...
        if coors.size(-1) == 3:
            ...
            print(
                f"\n\nPoints size before DynamicScatter3D:\t{points.shape}"\
                f"\nCoors size before DynamicScatter3D:\t{coors.shape}")
            ...
            # TODO: Reference prints
            print(
                f"\n\nFeatures size after DynamicScatter3D:\t{features.shape}"\
                f"\nFeature_coors size after DynamicScatter3D:\t{feature_coors.shape}"\
                "\n\n")
