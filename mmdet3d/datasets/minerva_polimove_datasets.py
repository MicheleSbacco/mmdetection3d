...
class MinervaLidarOnlyDataset(Det3DDataset):
    ...
    def __init__(self,
                 ...
                 pcd_limit_range: List[float] = [-80, -35, -2, 200, 35, 6],
                 **kwargs) -> None:
    ...
    def parse_ann_info(self, info: dict) -> dict:
        ...
        if ann_info is None:
            ...
            # NOTE: Apparently this part is NEVER entered, not in create_data and not even in the 
            # training (tested for create_data with KITTI_dataset, and with MVX-Net with KITTI_dataset)
        ...
        #       - Final choice: - Use the "LiDARInstance3DBoxes" just for coherence
        #                       - Use origin = (0.5, 0.5, 0.5)
        #                       - For cameras it is origin = (1., 1., 1.)
        #       - TODO: Also check the "load_type"
        gt_bboxes_3d = LiDARInstance3DBoxes(ann_info['gt_bboxes_3d'], origin=(.5, .5, 0.5))
