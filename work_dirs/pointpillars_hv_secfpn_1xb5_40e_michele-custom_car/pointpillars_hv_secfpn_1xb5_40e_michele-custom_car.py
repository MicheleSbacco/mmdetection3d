...
db_sampler = dict(
    ...
    data_root='data/michele_custom/',
    info_path='data/michele_custom/michele_custom_dbinfos_train.pkl',
    points_loader=dict(
        backend_args=None,
        coord_type='LIDAR',
        load_dim=4,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        test_mode=True,
        type='MicheleCustomDatasetNoImages'),
    drop_last=False,
    num_workers=1,
    persistent_workers=True,
    sampler=dict(shuffle=False, type='DefaultSampler'))
test_evaluator = dict(
    ann_file='data/michele_custom/michele_custom_infos_val.pkl',
    metric='bbox',
    type='KittiMetric')
test_pipeline = [
    dict(
            ...
            pipeline=[
                ...
                dict(
                    db_sampler=dict(
                        ...
                        data_root='data/michele_custom/',
                        info_path=
                        'data/michele_custom/michele_custom_dbinfos_train.pkl',
                        points_loader=dict(
                            backend_args=None,
                            coord_type='LIDAR',
                            load_dim=4,
...
work_dir = './work_dirs/pointpillars_hv_secfpn_1xb5_40e_michele-custom_car'
