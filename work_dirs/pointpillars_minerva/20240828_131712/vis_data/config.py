...
db_sampler = dict(
    ...
    prepare=dict(
        filter_by_difficulty=[
            -1,
        ], filter_by_min_points=dict(Car=20)),
    rate=1.0,
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        betas=(
            0.95,
            0.99,
        ), lr=0.1, type='AdamW', weight_decay=0.01),
    type='OptimWrapper')
param_scheduler = [
    dict(
        T_max=12,
        ...
        eta_min=0.010000000000000002,
        type='CosineAnnealingLR'),
    dict(
        T_max=12,
        begin=3.5999999999999996,
        by_epoch=True,
        convert_to_iter_based=True,
        end=7.199999999999999,
        eta_min=0.001,
        type='CosineAnnealingLR'),
    dict(begin=7.199999999999999, end=12, factor=0.005, type='ConstantLR'),
    dict(
        T_max=4.800000000000001,
        begin=0,
        by_epoch=True,
        convert_to_iter_based=True,
    ...
    dict(
        T_max=7.199999999999999,
        begin=4.800000000000001,
        convert_to_iter_based=True,
        end=12,
        eta_min=1,
        type='CosineAnnealingMomentum'),
...
train_cfg = dict(by_epoch=True, max_epochs=12, val_interval=4)
