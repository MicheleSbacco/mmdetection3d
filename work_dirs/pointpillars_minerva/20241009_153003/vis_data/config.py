...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            ...
            data_prefix=dict(pts='training/velodyne'),
            data_root=
            '/home/michele/iac_code/michele_mmdet3d/data/minerva_polimove/',
            metainfo=dict(classes=[
                'Car',
            ]),
            modality=dict(use_camera=False, use_lidar=True),
            pipeline=[
                ...
                dict(
                    db_sampler=dict(
                        ...
                        data_root='data/minerva_polimove/',
                        info_path=
                        '/home/michele/iac_code/michele_mmdet3d/data/minerva_polimove/minerva_polimove_dbinfos_train.pkl',
                        points_loader=dict(
                            backend_args=None,
                            coord_type='LIDAR',
                            load_dim=4,
