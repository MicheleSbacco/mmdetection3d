...
optim_wrapper = dict(
    ...
    type='OptimWrapper')
param_scheduler = [
    dict(begin=0, end=4.0, factor=0.1, type='ConstantLR'),
    dict(begin=4.0, end=8, factor=0.05, type='ConstantLR'),
    dict(
        T_max=3.2,
        begin=0,
        by_epoch=True,
...
train_cfg = dict(by_epoch=True, max_epochs=8, val_interval=2)
