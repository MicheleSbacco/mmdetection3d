...
test_evaluator = dict(
    ann_file='data/minerva_polimove/minerva_polimove_infos_train.pkl',
    metric='bbox',
    ...
    testing_mode = True,
    testing_reference_folder = "/home/michele/code/Presentation_results/PPillars_Checkpoints/PPillars_DynamicVox",
