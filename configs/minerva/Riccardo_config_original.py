...
data_root = '/mnt/ssd/Datasets/DatasetForTraining/IRIS_v1/'
...
db_sampler = dict(
    ...
    data_root='/mnt/ssd/Datasets/DatasetForTraining/IRIS_v1/',
    info_path=
    '/mnt/ssd/Datasets/DatasetForTraining/IRIS_v1/kittilidar_dbinfos_train.pkl',
    points_loader=dict(
        backend_args=None,
        coord_type='LIDAR',
        load_dim=4,
...
test_evaluator = dict(backend_args=None, type='LossesMetric')
test_pipeline = [
    dict(
        backend_args=None,
        coord_type='LIDAR',
            ...
            pipeline=[
                ...
                dict(
                    db_sampler=dict(
                        ...
                        data_root=
                        '/mnt/ssd/Datasets/DatasetForTraining/IRIS_v1/',
                        info_path=
                        '/mnt/ssd/Datasets/DatasetForTraining/IRIS_v1/kittilidar_dbinfos_train.pkl',
                        points_loader=dict(
                            backend_args=None,
...
val_dataloader = dict(
    ...
    persistent_workers=True,
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(backend_args=None, type='LossesMetric')
vis_backends = [
...
work_dir = './work_dirs/pointpillars_iris_v1_custom'
