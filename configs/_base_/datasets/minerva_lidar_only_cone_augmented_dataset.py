...
point_cloud_range = [0.0, -28.8, -2, 192, 28.8, 5]                  ## How to adjust? Use "tools/misc/browse_datase.py" after setting 
...
db_sampler = dict(
    data_root=data_root,
    info_path=data_root + 'minerva_polimove_cones_augmented_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
    ...
    points_loader=dict(
        ...
        coord_type='LIDAR',
        # NOTE:
        #   - The dimensions have been modified from 4 to 5
        #   - This is because the augmented pointcloud has an additional (5th) feature
        #   - This feature is 
        #       - "1" if the point is in the cone where the car-bbox has been found by the camera (usually YOLO neural network) 
        #       - "0" for all the other points
        load_dim=5,
        use_dim=5,
...
val_evaluator = dict(
    ...
    ann_file=data_root + 'minerva_polimove_cones_augmented_infos_val.pkl',
    metric='bbox'
)
