## Differences w.r.t. "just-car" version:
#       - Uses the db_sampler to filter the classes in a better way (copied from kitti-3d-3class)
#       - (trivial) has more classes in class_names
#       - Watch the "just-car" version for information on the TODO's 
...
class_names = ['Car', 'Pedestrian', 'Cyclist']  # replace with your dataset class
