...
from .minerva_polimove_data_utils import get_minerva_polimove_image_info
...
def create_minerva_polimove_info_file(data_path,
    ...
    #
    # ------------> No worries if the test set is empty: the pipeline "auto_labelling" is made in a way such that the
    #               "test.txt" file still exists, it is just empty
    ...
    # Define the path for saving the files that will be created
