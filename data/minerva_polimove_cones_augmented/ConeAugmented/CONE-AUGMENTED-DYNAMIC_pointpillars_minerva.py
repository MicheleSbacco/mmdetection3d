...
test_evaluator = dict(
    ann_file=
    'data/minerva_polimove_cones_augmented/minerva_polimove_cones_augmented_infos_val.pkl',
    ...
    metric='bbox',
    model_path=
    '/home/michele/code/michele_mmdet3d/configs/minerva/CONDENSED-DYNAMIC_pointpillars_minerva.py',
    reduced_x_limit=[
        -40,
        80,
    ],
...
val_evaluator = dict(
    ...
    metric='bbox',
    model_path=
    '/home/michele/code/michele_mmdet3d/configs/minerva/CONE-AUGMENTED-DYNAMIC_pointpillars_minerva.py',
    reduced_x_limit=[
        0,
        150,
    ],
